...
class DP3(BasePolicy):
    ...
    def predict_action(self, obs_dict: Dict[str, torch.Tensor]) -> Dict[str, torch.Tensor]:
        ...
        # Handle dual pointclouds or single pointcloud
        if not self.use_pc_color:
            if 'agentview_point_cloud' in nobs and 'eye_in_hand_point_cloud' in nobs:
                nobs['agentview_point_cloud'] = nobs['agentview_point_cloud'][..., :3]
                nobs['eye_in_hand_point_cloud'] = nobs['eye_in_hand_point_cloud'][..., :3]
            elif 'point_cloud' in nobs:
    ...
    def compute_loss(self, batch):
        ...
        # Compute action-specific losses (assuming action_dim dimensions per timestep)
        # loss shape: (batch_size, horizon, action_dim)
        # We need to extract just the action dimensions and compute component-wise losses
        ...
        # Typical format: [pos_x, pos_y, pos_z, rot_x, rot_y, rot_z, gripper]
        loss_dict = {
        ...
        if action_dim == 7:  # Standard 7-DOF format
            ...
            # Assuming each hand/agent has 7 DOF
