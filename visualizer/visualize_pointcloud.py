...
def enable_zoom_on_3d_axes(fig, axes_list):
    ...
    print("Scroll wheel zoom enabled (scroll up = zoom in, scroll down = zoom out)")
...
class ZarrPointCloudVisualizer:
    ...
    def visualize_episode_frames(self, episode_idx: int, frame_indices: List[int] = None,
        ...
        for local_idx in local_indices:
            if local_idx >= episode_length:
                print(f"WARNING: Skipping local frame {local_idx} (out of range)")
                continue
            ...
            print(f"\nVisualizing frame {local_idx}/{episode_length-1} (global index {global_idx})")
    ...
    def print_dataset_info(self):
        ...
        print(f"\nSample Point Cloud Statistics (first frame):")
...
def main():
    ...
    parser.add_argument('--zarr_path', type=str, 
                       default='your_own_file_path.zarr',
    ...
    try:
        ...
        print(f"ERROR: Error loading zarr file: {e}")
        return
