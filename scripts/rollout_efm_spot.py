...
"""
    ...
    Usage:
    ### EFM without Rect
        python rollout_efm_spot.py --ckpt /home/akash/UNH/EFM/FlowPolicy/checkpoints/efm/withoutRect/epoch=380-train_loss=0.061.ckpt \
    ...
    ### EFM
        python rollout_efm_spot.py --ckpt /home/akash/UNH/EFM/FlowPolicy/checkpoints/efm/withRect/epoch=300-train_loss=0.089.ckpt \
        --use-spot-hand-camera \
        --control-hz 10 \
        --show
        --use-student-t \
